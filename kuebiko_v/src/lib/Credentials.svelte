...
export const updateCredentials = () => {
  console.log("testing");
  console.log(openAPIValue , twitchTokenValue, twitchUserValue, googleCloudValue);
...
<div class = "inputField">
  ...
  <h4 class = "inputLabel">
    Google Cloud JSON Path
  </h4>
</div>
<div class = "buttons">
  <button id = "credentialsUpdate" on:click={updateCredentials}>
    Update!
  </button>
